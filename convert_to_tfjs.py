...
def convert_keras_to_tfjs():
    ...
    # Prioritize best_model.keras as it stores the highest validation accuracy checkpointed model
    if os.path.exists("model/best_model.keras"):
        keras_model_path = "model/best_model.keras"
    elif os.path.exists("model/padang_food_model_optimized.keras"):
